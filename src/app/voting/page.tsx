...
<div className="flex flex-col sm:flex-row gap-3 items-center justify-center">
  ...
  {votedTracks.length > 0 && (
    <button
      ...
      className="w-full sm:w-auto flex items-center justify-center space-x-2 text-black px-6 py-3 rounded-full font-semibold transition-all duration-200 hover:opacity-80"
      style={{ backgroundColor: '#ceae79' }}
    >
      <Trophy className="w-4 h-4" />
      <span>Votingergebnis anzeigen</span>
    </button>
  )}
  ...
  <button
    ...
    className="w-full sm:w-auto flex items-center justify-center space-x-2 bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-full font-semibold transition-all duration-200 disabled:opacity-50"
  >
